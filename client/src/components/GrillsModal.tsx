         ...
         >
            ...
            >
               ...
               <Grid container spacing={2}>
                  <Grid xs={12} item container sx={{ pt: 1, m: 3 }}>
                     <Grid xs={4}>
               ...
               <Grid sx={{ textAlign: "center" }}>
                  <Button sx={{ height: "50px", bgcolor: "whitesmoke" }}>Modificar</Button>
                  <Button sx={{ height: "50px", m: 2, bgcolor: "black", color: "white" }}>Cancelar</Button>
               </Grid>
            </Box>
         </Modal>
      </div>
